! function (e, t) {
    ...
    var n = /#(?:[0-9a-fA-F]{3}){1,2}/,
        o = /rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)/,
        r = "__inside__",
    ...
    if (c) {
        ...
        var f = u(),
            l = function () {
                localStorage.removeItem(r), d(t(t({}, window[r].theme.default), {
                    name: "default"
                }), !0)
            };
    ...
    function g(e) {
        ...
        var r = function (e, t) {
                var n = {},
                    o = e.accent_color,
                    r = e.foreground_color,
                    a = e.border_color,
                    i = e.background,
                    c = e.sidebar_background,
                    f = e.card_background,
                    l = e.content_width,
                    u = e.highlight,
                    d = function (e, t) {
            ...
            a = (r.card_background.match(n) || r.card_background.match(o) || [])[0] || r.foreground_color,
            c = s(r.accent_color);
        return "html{" + function (e, t) {
            ...
            function n(e, o, r) {
                ...
                var a = function (a) {
                    ...
                    else if ("object" == typeof i) n(i, o, a);
                    else {
                        var c = (r ? r + "_" : "") + a;
    ...
    e.css = g, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));